...
class Settings(BaseSettings):
    ...
    komax_group_jobs_api_url: str = (
        "https://jobs.komaxgroup.com/services/recruiting/v1/jobs"
    )
    komax_group_jobs_timeout_seconds: float = Field(default=30.0, ge=1, le=120)
    ...
    bms_switzerland_jobs_base_url: str = (
    ...
    bms_switzerland_jobs_api_url: str = "https://jobs.bms.com/api/pcsx/search"
    bms_switzerland_jobs_detail_api_url: str = (
        "https://jobs.bms.com/api/pcsx/position_details"
    )
    bms_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0, ge=1, le=120
    )
    bms_switzerland_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    bms_switzerland_jobs_max_catalog_passes: int = Field(
        default=3, ge=1, le=20
    )
    bms_switzerland_jobs_detail_workers: int = Field(
        default=8, ge=1, le=20
    )
    ...
    pwc_switzerland_jobs_base_url: str = (
        "https://www.pwc.ch/en/careers-with-pwc/open-positions.html"
    )
    pwc_switzerland_jobs_api_url: str = (
        "https://ohws.prospective.ch/public/v1/medium/1000311/jobs"
    )
    ...
    gsk_switzerland_jobs_base_url: str = (
        "https://jobs.gsk.com/gb/en/search-results?"
        "keywords=&location=Switzerland&lang=en-gb"
    )
    gsk_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    gsk_switzerland_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    gsk_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    gsk_switzerland_jobs_page_workers: int = Field(default=10, ge=1, le=20)
    gsk_switzerland_jobs_detail_workers: int = Field(default=8, ge=1, le=20)
    sanofi_switzerland_jobs_base_url: str = (
        "https://jobs.sanofi.com/en/search-jobs/Switzerland/2649/2/2658434/"
        "47x00016/8x01427/50/2"
    )
    sanofi_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    sanofi_switzerland_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    sanofi_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    sanofi_switzerland_jobs_page_workers: int = Field(default=10, ge=1, le=20)
    sanofi_switzerland_jobs_detail_workers: int = Field(default=8, ge=1, le=20)
    takeda_switzerland_jobs_base_url: str = "https://jobs.takeda.com/search-jobs"
    takeda_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    takeda_switzerland_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    takeda_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    takeda_switzerland_jobs_page_workers: int = Field(default=10, ge=1, le=20)
    takeda_switzerland_jobs_detail_workers: int = Field(default=8, ge=1, le=20)
    jnj_switzerland_jobs_base_url: str = (
        "https://www.careers.jnj.com/en/jobs/?"
        "search=&country=Switzerland&origin=global"
    )
    jnj_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    jnj_switzerland_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    jnj_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    jnj_switzerland_jobs_page_workers: int = Field(default=4, ge=1, le=20)
    jnj_switzerland_jobs_detail_workers: int = Field(default=8, ge=1, le=20)
    zurich_insurance_jobs_base_url: str = (
    ...
    zurich_insurance_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    zurich_insurance_jobs_max_pages: int = Field(default=100, ge=1, le=500)
    zurich_insurance_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    zurich_insurance_jobs_detail_workers: int = Field(default=8, ge=1, le=20)
    schneider_electric_switzerland_jobs_base_url: str = (
        "https://careers.se.com/jobs?lang=de-DE&country=Switzerland&page=1"
    )
    schneider_electric_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    schneider_electric_switzerland_jobs_max_pages: int = Field(
        default=100,
        ge=1,
        le=500,
    )
    schneider_electric_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    schneider_electric_switzerland_jobs_page_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    bosch_switzerland_jobs_base_url: str = (
        "https://jobs.bosch.com/en/?pages=1&country=ch#"
    )
    bosch_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    bosch_switzerland_jobs_page_size: int = Field(
        default=100,
        ge=1,
        le=200,
    )
    bosch_switzerland_jobs_max_pages: int = Field(
        default=100,
        ge=1,
        le=500,
    )
    bosch_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    bosch_switzerland_jobs_page_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    eviden_switzerland_jobs_base_url: str = (
        "https://eviden.com/careers/?country=CH"
    )
    eviden_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    eviden_switzerland_jobs_max_catalog_records: int = Field(
        default=2_000,
        ge=1,
        le=20_000,
    )
    eviden_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    schindler_switzerland_jobs_base_url: str = (
        "https://job.schindler.com/search/?createNewAlert=false&q="
        "&locationsearch=&optionsFacetsDD_country=CH"
    )
    schindler_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    schindler_switzerland_jobs_max_pages: int = Field(
        default=20,
        ge=1,
        le=200,
    )
    schindler_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    schindler_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    ...
    csl_switzerland_jobs_base_url: str = (
    ...
    csl_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    csl_switzerland_jobs_max_pages: int = Field(
        default=50,
        ge=1,
        le=200,
    )
    csl_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=10,
    )
    csl_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    lonza_switzerland_jobs_base_url: str = (
        "https://www.lonza.com/careers/job-search"
    )
    lonza_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    lonza_switzerland_jobs_max_pages: int = Field(
        default=50,
        ge=1,
        le=200,
    )
    lonza_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=10,
    )
    lonza_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    ...
    afry_switzerland_jobs_base_url: str = (
        "https://afry.com/de-ch/karriere/verfugbare-stellen"
    )
    afry_switzerland_jobs_catalog_url: str = (
        "https://afry.com/de-ch/api/afp-hr-smartrecruiteres-job-list"
    )
    afry_switzerland_jobs_detail_api_url: str = (
        "https://api.smartrecruiters.com/v1/companies/AFRY/postings"
    )
    afry_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    afry_switzerland_jobs_max_catalog_records: int = Field(
        default=2_000,
        ge=1,
        le=20_000,
    )
    afry_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    digital_realty_switzerland_jobs_base_url: str = (
        "https://hdep.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/"
        "CX/jobs?location=Switzerland&locationId=300000000361301&"
        "locationLevel=country&mode=job-location"
    )
    digital_realty_switzerland_jobs_api_url: str = (
        "https://hdep.fa.us2.oraclecloud.com/hcmRestApi/resources/latest"
    )
    digital_realty_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    digital_realty_switzerland_jobs_max_pages: int = Field(
        default=50,
        ge=1,
        le=200,
    )
    digital_realty_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    digital_realty_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    ...
    crossing_switzerland_jobs_base_url: str = (
        "https://crossing.recruitee.com/?jobs-c88dea0d%5Bcountry%5D%5B%5D=CH"
    )
    crossing_switzerland_jobs_api_url: str = (
        "https://crossing.recruitee.com/api/offers/"
    )
    crossing_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    crossing_switzerland_jobs_max_jobs: int = Field(
        default=500,
        ge=1,
        le=5_000,
    )
    ...
    sharp_switzerland_jobs_base_url: str = "https://www.sharp.ch/de/jobs-bei-sharp"
    sharp_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    sharp_switzerland_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    sharp_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    unisys_switzerland_jobs_base_url: str = (
        "https://unisys.wd5.myworkdayjobs.com/External?"
        "locationCountry=187134fccb084a0ea9b4b95f23890dbe"
    )
    unisys_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    unisys_switzerland_jobs_max_pages: int = Field(
        default=100,
        ge=1,
        le=500,
    )
    unisys_switzerland_jobs_max_catalog_passes: int = Field(
        default=3,
        ge=1,
        le=20,
    )
    unisys_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    rdm_switzerland_jobs_base_url: str = (
        "https://www.rdm.com/career/jobs/?mf-job_country%5B0%5D=ch"
    )
    rdm_switzerland_jobs_timeout_seconds: float = Field(
        default=45.0,
        ge=1,
        le=120,
    )
    rdm_switzerland_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    rdm_switzerland_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    lyreco_switzerland_jobs_base_url: str = (
        "https://www.lyreco.com/group/switzerland/de/jobs?"
        "f%5B0%5D=job_location%3Adietikon%20zh"
    )
    lyreco_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    lyreco_switzerland_jobs_max_pages: int = Field(
        default=100,
        ge=1,
        le=500,
    )
    lyreco_switzerland_jobs_max_jobs: int = Field(
        default=1_000,
        ge=1,
        le=5_000,
    )
    lyreco_switzerland_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    ...
    aity_jobs_base_url: str = "https://aity.ch/jobs"
    aity_jobs_career_center_url: str = "https://jobs.aity.ch/"
    aity_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    aity_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    aity_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=20,
    )
    arcon_jobs_base_url: str = (
        "https://www.arcon.ch/ict-und-abacus-jobs/#OffeneStellen"
    )
    arcon_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    arcon_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    arcon_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    boss_info_jobs_base_url: str = "https://www.bossinfo.com/karriere/jobs/"
    boss_info_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    boss_info_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    boss_info_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    clavis_it_jobs_base_url: str = "https://www.clavisit.com/karriere/jobs"
    clavis_it_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    clavis_it_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    clavis_it_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    datahouse_zurich_jobs_base_url: str = "https://www.datahouse.ch/en/career/"
    datahouse_zurich_jobs_detail_api_url: str = (
        "https://api.smartrecruiters.com/v1/companies/wuestpartner/postings"
    )
    datahouse_zurich_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    datahouse_zurich_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    datahouse_zurich_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    esurance_jobs_base_url: str = "https://esurance.ch/work-with-us/?lang=en"
    esurance_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    esurance_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    esurance_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    helga_jobs_base_url: str = "https://www.helga.ch/jobs"
    helga_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    helga_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    helga_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    karakun_jobs_base_url: str = "https://karakun.com/en/jobs/"
    karakun_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    karakun_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    karakun_jobs_detail_workers: int = Field(
        default=8,
        ge=1,
        le=12,
    )
    lake_jobs_base_url: str = "https://lake.ch/ueber-uns/karriere"
    lake_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    lake_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    lake_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    ...
    rey_technology_jobs_base_url: str = (
        "https://www.rey-technology.com/en/career/vacancies/"
    )
    rey_technology_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    rey_technology_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    rey_technology_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
    schurter_switzerland_jobs_base_url: str = (
        "https://www.schurter.com/de/karriere/offene-stellen?country=CH"
    )
    schurter_switzerland_jobs_api_url: str = (
        "https://www.schurter.com/api/website/v1/jobs"
    )
    schurter_switzerland_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    schurter_switzerland_jobs_max_jobs: int = Field(
        default=1_000,
        ge=1,
        le=5_000,
    )
    smino_jobs_base_url: str = "https://smino.jobs.personio.com/"
    smino_jobs_timeout_seconds: float = Field(
        default=30.0,
        ge=1,
        le=120,
    )
    smino_jobs_max_jobs: int = Field(
        default=100,
        ge=1,
        le=1_000,
    )
    smino_jobs_detail_workers: int = Field(
        default=6,
        ge=1,
        le=12,
    )
